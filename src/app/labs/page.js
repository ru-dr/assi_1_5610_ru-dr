  ...
  const labs = [
    {
      ...
      description:
        "Complete HTML elements practice including forms, tables, lists, images, and more",
    },
    {
      id: "lab2",
      title: "Lab 2 - CSS Styling Fundamentals",
      description:
        "Learn CSS selectors, properties, flexbox, grid layouts, and responsive design techniques",
    },
    {
      id: "lab3",
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto bg-white dark:bg-[#0a0a0a] text-gray-900 dark:text-gray-100">
      ...
      <p className="text-lg text-gray-700 dark:text-gray-300 mb-8">
        Welcome to the Labs section. Here you can access different lab
