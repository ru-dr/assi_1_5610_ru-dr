  ...
  return (
    <div className="p-6 max-w-6xl mx-auto bg-white dark:bg-[#0a0a0a] text-gray-900 dark:text-gray-100">
      ...
      <section className="mb-8">
        ...
        <div className="space-y-2 font-mono text-sm">
          <div>integerVariable = {variableScalars.integerVariable}</div>
          <div>typeOfIntegerVariable = {typeof variableScalars.integerVariable}</div>
          <div>floatingPointNumber = {variableScalars.floatingPointNumber}</div>
          <div>typeOfFloatingPointNumber = {typeof variableScalars.floatingPointNumber}</div>
          <div>stringVariable = {variableScalars.stringVariable}</div>
          <div>typeOfStringVariable = {typeof variableScalars.stringVariable}</div>
        </div>
      </section>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Ternary Conditional Operator</h2>
        <div className="space-y-2 font-mono text-sm">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Generating Conditional Output</h2>
        <div className="space-y-2 font-mono text-sm">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Adding and Removing Data to/from Arrays</h2>
        <div className="space-y-2 font-mono text-sm">
          <div>numberArray1 = [{numberArray1.join(", ")}]</div>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">JavaScript Object Notation (JSON)</h2>
        <div className="space-y-2 font-mono text-sm">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Implementing a Simple ToDo List using React.js</h2>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Working with HTML Classes</h2>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Red Dangerous Background</h2>
        <div className="space-y-2">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Blue Dynamic Blue Background</h2>
        <div className="space-y-2">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Working with the HTML Style Attribute</h2>
        <div className="space-y-2">
          <div style={{ 
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Styles: Yellow, Red, Blue Backgrounds</h2>
        <div className="space-y-2">
          <div style={{ 
            backgroundColor: "yellow", 
            color: "black", 
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Parameterizing Components</h2>
        <div className="space-y-2">
          <Square color="red" />
          <Square color="blue" />
        </div>
