...
export default function AssignmentEditor({ params }) {
  ...
  const assignmentsData = {
    a1: {
      id: 'a1',
      name: 'Assignment 1',
      description: 'This assignment covers the core concepts of the course. Students will demonstrate their understanding through practical implementation.',
      points: 100,
      dueDate: '2025-09-23',
    ...
    a2: {
      id: 'a2',
      name: 'Assignment 2',
      description: 'Advanced assignment building on previous concepts with more complex requirements and implementation challenges.',
      points: 150,
      dueDate: '2025-09-30',
    ...
    a3: {
      id: 'a3',
      name: 'Assignment 3',
      description: 'Final project assignment integrating all course concepts into a comprehensive application.',
      points: 200,
      dueDate: '2025-10-07',
      ...
      <form className="space-y-6 max-w-2xl">
        ...
        <div>
          ...
          <textarea 
            ...
            rows="4"
            defaultValue={assignment ? assignment.description : 'Assignment description...'}
            className="border border-gray-300 dark:border-gray-600 px-3 py-2 rounded w-full bg-white dark:bg-[#171717] text-gray-900 dark:text-gray-100"
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            <label htmlFor="availableDate" className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">Available Date</label>
            <input 
              type="date" 
              id="availableDate" 
              defaultValue={assignment ? assignment.availableDate : '2025-09-22'}
              className="border border-gray-300 dark:border-gray-600 px-3 py-2 rounded w-full bg-white dark:bg-[#171717] text-gray-900 dark:text-gray-100"
            />
          </div>
          
          <div>
            <label htmlFor="dueDate" className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">Due Date</label>
            <input 
              type="date" 
              id="dueDate" 
        ...
        <div>
          <label htmlFor="assignmentType" className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-300">Assignment Type</label>
          <select 
            id="assignmentType" 
            className="border border-gray-300 dark:border-gray-600 px-3 py-2 rounded w-full bg-white dark:bg-[#171717] text-gray-900 dark:text-gray-100"
          >
        ...
        <div>
          <label className="flex items-center space-x-2">
            ...
            />
            <span className="text-sm text-gray-700 dark:text-gray-300">Publish Assignment</span>
          </label>
        </div>

        <div className="space-x-4">
          <button type="button" className="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">Save</button>
          <button type="button" className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Save & Publish</button>
          <Link 
            href={`/courses/${courseId}/assignments`}
