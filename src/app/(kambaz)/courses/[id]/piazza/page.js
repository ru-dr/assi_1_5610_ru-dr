  ...
  const renderCourseNav = () => (
    <div className="bg-gray-100 dark:bg-[#0a0a0a] p-4 border-r border-gray-300 dark:border-gray-600 w-48">
      ...
      <ul className="space-y-2">
        ...
        <li><Link href={`/courses/${courseId}/piazza`} className="block w-full text-left p-2 rounded bg-blue-100 dark:bg-blue-900 text-blue-900 dark:text-blue-100">💬 Piazza</Link></li>
      ...
      <div className="flex flex-1 bg-white dark:bg-[#0a0a0a]">
        ...
        <div className="flex-1 text-gray-900 dark:text-gray-100 p-6">
          ...
          <div className="bg-orange-100 dark:bg-orange-900 p-4 rounded border border-orange-300 dark:border-orange-700 mb-6">
            <p className="text-sm text-orange-800 dark:text-orange-200">📢 Welcome to the {course?.title} discussion forum! Ask questions and collaborate with your classmates.</p>
          </div>
          <div className="space-y-4">
            <div className="bg-white dark:bg-[#171717] p-4 rounded border border-gray-300 dark:border-gray-600">
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">📌 Assignment Questions</h3>
              <p className="text-gray-700 dark:text-gray-300 text-sm mb-2">Posted by Student A - 2 hours ago</p>
              <p className="text-gray-700 dark:text-gray-300">Can someone help clarify the requirements for the latest assignment?</p>
