    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="bg-purple-100 p-4 rounded border border-purple-300 mb-6">
            <p className="text-sm text-purple-800">
              📝 Complete quizzes to test your understanding of course material.
            </p>
          </div>
          <div className="space-y-4">
            <div className="bg-white p-4 rounded border border-gray-300 shadow-sm">
              <div className="flex justify-between items-center">
                <div>
                  <h3 className="font-semibold text-gray-900">Quiz 1</h3>
                  <p className="text-sm text-gray-600">
                    Due: Monday at 11:59pm | 10 points
                  </p>
                </div>
            ...
            <div className="bg-white p-4 rounded border border-gray-300 shadow-sm">
              <div className="flex justify-between items-center">
                <div>
                  <h3 className="font-semibold text-gray-900">Quiz 2</h3>
                  <p className="text-sm text-gray-600">
                    Due: Wednesday at 11:59pm | 15 points
                  </p>
                </div>
                <button className="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">
                  Take Quiz
